...
import { Box, Typography, Accordion, AccordionSummary, AccordionDetails } from "@mui/material"; // main MUI components
...
const faqData = {
    General: [
        ...
        },
        {
            ...
            answer: "If you're a current college student or graduated within the last year, you're invited! Beginners are more than welcome too.",
        },
        {
        ...
        },
        {
            ...
            answer: "Nothing! HackUSF is completely free for all participants. All you need to focus on is learning, building amazing projects, and enjoying the experience.",
        },
        {
            question: "What if I've never attended a hackathon before?",
            answer: "No worries! HackUSF is beginner-friendly. Our workshops, mentors, and welcoming community will make it easy to get started and build your confidence throughout the event.",
        },
        {
            question: "Is HackUSF in person or virtual?",
            answer: "HackUSF is fully in-person! From check-in to project submissions and demos, everything happens on-site, so make sure you can attend in person before registering.",
        },
    ],
    Preparation: [
        {
...
// Change handling for the accordions...closes old ones when new are clicked or when the same accordion is clicked again.
    ...
    return (
        <Box
            sx={{
                bgcolor: "#385BB2",  // blue background
