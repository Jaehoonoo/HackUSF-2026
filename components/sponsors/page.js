...
const platinumSponsors = [
  { src: "/images/gdglogo.webp", alt: "Google - HackUSF", link: "https://about.google/" },

];

const goldSponsors = [
  { src: "/images/gdglogo.webp", alt: "Google - HackUSF", link: "https://about.google/" },
  { src: "/images/gdglogo.webp", alt: "Moffitt - HackUSF", link: "https://moffitt.org" },
  { src: "/images/gdglogo.webp", alt: "Google - HackUSF", link: "https://about.google/" },
...
const CompanyBubble = ({ name, logo, isMobile, size = 336, decorSize = 126, logoAlt = "logo", link }) => {
  // More aggressive mobile scaling - smaller bubbles on mobile
  const actualSize = isMobile ? size * 0.45 : size;
  const actualDecorSize = isMobile ? decorSize * 0.50 : decorSize;
...
function Sponsors() {
  ...
  return (
      ...
      >
        ...
        <Box>
          {/* Sponsors Flexboard */}
          <Box sx={{ position: "relative", pt: { xs: 4, md: 6 }, pb: { xs: 2, md: 4 }, zIndex: 2 }}>
            <Typography
              variant="h2"
              sx={{
                fontFamily: "var(--font-cinzel-bold)",
          ...
          {/* Partners Flexboard */}
          <Box sx={{ position: "relative", pt: { xs: 2, md: 4 }, pb: { xs: 6, md: 10 }, zIndex: 2 }}>
            <Typography
              variant="h2"
              sx={{
                fontFamily: "var(--font-cinzel-bold)",
